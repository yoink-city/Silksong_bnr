...
namespace Silksong
{
    public class Dialogue{
        ...
        public static Dictionary<string,string> KeyMap = new Dictionary<string,string>(){
            ...
            {$"HORNET_FOUNTAIN_1",$"Again we meet, imposter.<page>I'm normally quite perceptive. You I do not understand, though I've since sensed part of the truth.<page>You're from beyond this kingdom's bounds. Your's is a resilience born of adversity.<page>It's no surprise then that you've managed to reach the heart of this world. but you now know the sacrifice that keeps it standing."},
